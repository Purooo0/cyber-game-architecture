...
router.get("/admin/feedback/all", authenticate, gameController.getAllFeedbackAnswers)
router.get("/admin/feedback/scenario/:scenarioId", authenticate, gameController.getFeedbackByScenario)
router.get("/admin/feedback/user/:userId", authenticate, gameController.getFeedbackByUser)
